...
const AddSurveyValue = ({navigation,route}) => {
  ...
  let loadSurveyDetails = route.params.loadSurveyDetails;
  ...
  const handleSubmit = async() => {
    ...
    try{
        ...
        const result = await dispatch(addSurveyValue(token, value));
        loadSurveyDetails();
        navigation.navigate('UpdateSurvey', { idSurvey: idSurvey,loadList:loadList })
    }catch(error){
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.pageTitle}>Add Value</Text>
      ...
      <TouchableOpacity style={styles.submitButton}
          ...
          >
              <Text style={styles.submitButtonText}>Add Value</Text>
          </TouchableOpacity>
          </View>
    </ScrollView>
  );
